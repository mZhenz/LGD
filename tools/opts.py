...
def parse_opt():
    ...
    parser.add_argument('--text',
                        default='imagenet',
                        type=str,
                        help='choose the used nature language')

    parser.add_argument('--dataset',
                        default='imagenet',
                        choices=['coco', 'imagenet', 'caltech'],
    ...
    parser.add_argument('--val-data',
                        default='/dockerdata/ILSVRC/Data/CLS-LOC/val/',
                        help='path to val set')

    parser.add_argument('--val-interval',
                        type=int,
                        default=5,
                        help='how many epoch evaluate the model')
    ...
    # settings of mean classification score
